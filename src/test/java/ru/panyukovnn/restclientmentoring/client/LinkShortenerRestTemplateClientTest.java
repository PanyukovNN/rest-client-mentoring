...
class LinkShortenerRestTemplateClientTest extends AbstractWireMockTest {
    ...
    void when_callCreateShortLink_then_success() {
        ...
        LinkInfoResponse response = restTemplateClient.postCreateLinkInfo(CREATE_SHORT_LINK_REQUEST);
