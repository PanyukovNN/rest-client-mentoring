...
public class AbstractWireMockTest extends AbstractTest {
    ...
    @SneakyThrows
    protected void stubResponse(String url, HttpMethod method, CommonResponse<?> commonResponse) {
        stubResponseWithDelay(url, method, commonResponse, 0);
    }

    @SneakyThrows
    protected void stubResponseWithDelay(String url, HttpMethod method, CommonResponse<?> commonResponse, int delay) {
